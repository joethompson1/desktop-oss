...
> Claude Code as `CLAUDE.md`. If another tool (Cursor, Codex, Copilot)
> ever needs the same rules, symlink its rules file to this one rather
> than copying — keep one source of truth.
